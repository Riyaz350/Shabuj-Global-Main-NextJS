...
export const metadata: Metadata = {
    title: 'Study in the Switzerland and build your future',
    description: 'Learn from the worlds best academics and study at prestigious Switzerland universities.',
  }
const page = () => {
    return (
        <div>
